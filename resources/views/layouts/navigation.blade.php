<nav class="py-2 bg-light border-bottom">
    <div class="container d-flex flex-wrap">
        <ul class="nav me-auto">
            ...
            <li class="nav-item"><a href="{{route('Teleport.index')}}" class="nav-link link-dark px-2 @if(request()->routeIs('Teleport.index')) active @endif " aria-current="page">Teleports</a></li>
                    </ul>
        <ul class="nav">
            @auth()
                <li class="nav-item">
